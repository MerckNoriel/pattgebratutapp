...
import 'package:pattgebratutapp/understandingalgebraicexpression.dart';
...
class AlgebraicExpressionPage extends StatefulWidget {
  const AlgebraicExpressionPage({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _AlgebraicExpressionPage createState() => _AlgebraicExpressionPage();
}

class _AlgebraicExpressionPage extends State<AlgebraicExpressionPage> {
                              ...
                              GestureDetector(
                                ...
                                onTap: () {
                                  Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                          builder: (context) =>
                                              const Understandingalgebraicexpression1()));
                                },
                              )
                            ],
                          ),
...
void main() => runApp(const MaterialApp(home: AlgebraicExpressionPage()));
