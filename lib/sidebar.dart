...
import 'package:pattgebratutapp/changepassword.dart';
import 'package:pattgebratutapp/login.dart';
          ...
          DrawerHeader(
            ...
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  Color.fromARGB(255, 37, 78, 7), // Dark green
                  Color.fromARGB(255, 177, 255, 132), // Light green
                ],
              ...
              : Container(
                  ...
                  child: GestureDetector(
                    child: const Text(
                      'Logout',
                      style: TextStyle(
                          color: Color.fromARGB(255, 255, 17, 0), fontSize: 18),
                    ),
                    onTap: () {
                      // Handle Settings tap
                      showDialog(
