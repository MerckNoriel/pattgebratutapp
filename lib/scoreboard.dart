              ...
              child: Column(
                children: [
                  ...
                  widgetScoreboard(
                      ...
                      'Pre - Test',
                      'Post Test',
                      algebraicequationpretestscore.toString(),
                      'Understanding Algebraic Equation',
                      algebraicequationposttestscore.toString()),
                  widgetScoreboard(
                      'Lessong 4',
                      'Solving Equation',
                      'Pre - Test',
                      'Post Test',
                      solvingequationpretestscore.toString(),
                      'Understanding Solving Equation',
                      solvingequationposttestscore.toString()),
                ],
              ),
            ),
          ],
