...
class _ThenthtermofasequencepretestviewPage
  ...
  final List<Map<String, dynamic>> questions = [
    ...
    {
      "question": "What is the common difference in the arithmetic \n"
          "sequence 5, 10, 15, 20?",
      "options": ["5", "10", "15", "20"],
      "answer": "5"
    },
    ...
    {
      "question": "In the arithmetic sequence defined by the formula \n"
          "an = 2 + (n - 1) x 3 , what is the first term (n = 1)?",
      "options": ["5", "3", "2", "6"],
      "answer": "2"
    },
    {
    ...
    {
      "question": "For the geometric sequence defined by the formula \n"
          "an = 3 x 2^(n-1), what is the second term (n = 2)?",
      "options": ["3", "6", "9", "12"],
      "answer": "6"
    },
    {
    ...
    {
      "question": "If a geometric sequence has a first term \n"
          "of 1 and a common ratio of 3, what is the formula for the nth term?",
      "options": [
        "an = 3^(n-1)",
        "an = 1 x 3^(n-1)",
        "an = 1 + 3^(n-1)",
